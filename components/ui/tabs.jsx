...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center xl:bg-muted bg-muted p-1 text-muted-foreground rounded-[30px] dark:md:bg-secondary ",
      className
    )}
    {...props} />
))
